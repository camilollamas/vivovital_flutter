...
class LoginProvider extends GetConnect {
  ...
  Future<dynamic> login(Object data) async {
    print('entra al login provider login_provider => data ${data}');
    ...
    print('login_provider => response1 ${response.body}');
    Map body = response.body ?? "error";

    print('login_provider => body ${body}');
